...
export const mockAssets: Asset[] = [
  ...
  { id: "AST-008", name: "Harvest Labor Team (20 workers)", category: "Worker Group", subCategory: "Harvest Workers", owner: "AgriWorkers Union", ownerId: "USR-P005", price: 500000, priceUnit: "per day", location: "Nagpur", availability: "Available", rating: 4.4, approvalStatus: "Approved", image: "👷", description: "Experienced team of 20 farm workers for harvest operations.", createdAt: "2024-01-20T06:00:00Z", serviceArea: "Central India", operatorAvailable: true, maleWorkersCount: 12, femaleWorkersCount: 8 },
  { id: "AST-009", name: "Planting Team (15 workers)", category: "Worker Group", subCategory: "Planting Workers", owner: "Field Masters", ownerId: "USR-P006", price: 350000, priceUnit: "per day", location: "Coimbatore", availability: "Booked", rating: 4.1, approvalStatus: "Pending", image: "🌱", description: "Skilled planting team for various crop types.", createdAt: "2024-09-10T13:00:00Z", serviceArea: "Southern India", operatorAvailable: true, maleWorkersCount: 5, femaleWorkersCount: 10 },
